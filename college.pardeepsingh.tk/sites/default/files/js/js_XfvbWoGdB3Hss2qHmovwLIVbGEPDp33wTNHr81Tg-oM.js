...
/**
 * @file
 * Override views JS behaviors.
 */
(function($, Drupal) {
  Drupal.behaviors.sjuViewsScroll = {
    attach: function() {

      // This comes wholesale from core/views/js/ajax_view.js.
      Drupal.AjaxCommands.prototype.viewsScrollTop = function(ajax, response) {
        ...
        if (offset.top - 10 < $(scrollTarget).scrollTop()) {
          // Set scroll offset a bit higher from the default 10.
  ...
  function getAlerts() {
    $.get('/mir3-banner-alerts', function(data) {
      if (data) {
        ...
        $('#mir3-banner-messages').html(data);
      }
      else {
